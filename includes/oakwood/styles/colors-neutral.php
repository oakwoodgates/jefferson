 ...
 */
Kirki::add_section( 'neutral_colors', array(
    'priority'    => 10,
    'title'       => __( 'Neutral Colors', 'kirki' ),
...
Kirki::add_field( $config, array(
    'type'        => 'palette',
    'setting'     => 'neutral_colors_palette',
    'label'       => __( 'Neutral Colors', 'kirki' ),
